...
void DesenhaCuboRGB(void)
{
  ...
  glColor3ub(2, 2, 255);              // Set Color To Blue
...
int main(int argc, char **argv){
  ...
  softbodySimulation = new
    SoftBodySimulation(
		       15,         // 3 Particles (Masses) on X
		       15,         // 3 Particles (Masses) on Y
		       1,          // 2 Particles (Masses) on Z
		       0.01f,      // Each Particle Has A Weight Of 50 Grams
		       0.1f,      // springConstant In The SoftBody
		       10.0f,       // Normal Length Of Springs In The SoftBody
		       0.01f,       // Spring Inner Friction Constant
		       Vector3D(0, 0, 10), // Gravitational Acceleration
		       0.001f,        // Air Friction Constant
		       0.0f,       // Ground Repel Constant
		       0.0f,       // Ground Slide Friction Constant
		       0.0f,       // Ground Absoption Constant
		       1.0f);     // Height Of Ground
